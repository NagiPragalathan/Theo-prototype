        ...
        {conversation.messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl w-full">
              {[
  {
    "title": "Crypto Concepts & Trading Strategies",
    "desc": "Learn about different strategies, trading techniques, and concepts in crypto",
    "icon": "📚",
    "questions": [
      "What are the best strategies for day trading cryptocurrencies?",
      "Can you explain what a stop loss is in crypto trading?",
      "How do I use leverage in crypto trading safely?",
      "What is the difference between spot and margin trading?",
      "Are there any low-risk crypto investment strategies?"
    ]
  },
  {
    "title": "Technical Analysis Indicators",
    "desc": "Learn about technical indicators and how to use them in crypto trading",
    "icon": "📊",
    "questions": [
      "How do I use the Relative Strength Index (RSI) to spot overbought or oversold conditions?",
      "What are moving averages, and how can I use them in crypto trading?",
      "Can you explain how to identify support and resistance levels on a crypto chart?",
      "How do I read candlestick patterns to predict market movements?",
      "What does the MACD indicator tell me about crypto trends?"
    ]
  },
  {
    "title": "Portfolio Management & Optimization",
    "desc": "Track your portfolio performance and get tips on rebalancing and optimization",
    "icon": "💼",
    "questions": [
      "How can I track the performance of my crypto portfolio?",
      "What are some strategies for rebalancing my crypto portfolio?",
      "How do I manage risk when investing in crypto assets?",
      "Can you help me with tax optimization strategies for my crypto holdings?",
      "What should my portfolio look like if I want to minimize risk but still earn returns in crypto?"
    ]
  }
]
.map((category, i) => (
                <motion.div
                  key={i}
                  className="bg-white rounded-xl border border-gray-200 hover:border-blue-500 transition-all duration-200 shadow-sm hover:shadow group overflow-hidden"
                ...
                >
                  <div className="p-4 border-b border-gray-100">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-medium text-gray-800 mb-1 group-hover:text-blue-700 transition-colors">{category.title}</h3>
                  ...
                  <div className="p-4 space-y-2">
                    {category.questions.map((question, qIndex) => (
                      <motion.button
                        key={qIndex}
                        className="w-full text-left p-2 rounded-lg hover:bg-gray-50 text-sm text-gray-600 hover:text-blue-700 transition-colors"
                        onClick={() => {
                          setMessage(question);
                          if (textareaRef.current) {
